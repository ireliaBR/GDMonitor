...
//////////////////////////////////////
NS_INLINE BOOL gd_isTaggedPointer(const void *ptr)  {
    #if OBJC_HAVE_TAGGED_POINTERS
...
#define GDPointerIsTaggedPointer(obj) gd_isTaggedPointer((__bridge void *)obj)

/// Whether the given pointer is a valid, readable address.
BOOL GDPointerIsReadable(const void * ptr);
