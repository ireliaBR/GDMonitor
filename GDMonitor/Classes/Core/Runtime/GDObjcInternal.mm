...
////////////////////////////////////////////////
NS_INLINE BOOL gd_isExtTaggedPointer(const void *ptr)  {
...
BOOL GDPointerIsReadable(const void *inPtr) {
...
BOOL GDPointerIsValidObjcObject(const void *ptr) {
    ...
    if (gd_isTaggedPointer(ptr) || gd_isExtTaggedPointer(ptr)) {
        return YES;
    }
#endif
    ...
    if (!cls || !GDPointerIsReadable((__bridge void *)cls)) {
        return NO;
    }
    ...
    if (!metaclass || !GDPointerIsReadable((__bridge void *)metaclass)) {
        return NO;
    }
